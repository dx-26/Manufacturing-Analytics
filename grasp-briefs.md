...
**Resources:** Exact JSON files `meetings.json` and `signals.json`; `SKILL.md`; Visual Studio Code with Node.js 18+; JavaScript batch script `batch_memos.js`; Markdown outputs in `outputs/`.
